(ns clojure_fullschtack.server-components.pathom
  (:require
    ...
    ;; Central registry
    [clojure_fullschtack.server-components.pathom-wrappers :refer [pathom-registry]]
    ...
    clojure_fullschtack.model.user))
